		...
		<div className="editor-container">
			...
			<div className="editor-image">
				...
				{ 
					...
					(images) ? <img className="image-modal" src={images[position].src} style={getImageStyle()} ref={imgRef}/> 
			...
			<aside className="editor-aside">
				...
				<button onClick={() => saveEditImage(imgRef.current,images[position])}>guardar</button>
				
				<select className="editor-options" onChange={({target}) => setSelectedOptionIndex(parseInt(target.value))}>
